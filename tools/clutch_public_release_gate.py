...
PUBLIC_GITHUB_REPO_URL = "https://github.com/TREX-CLUTCH/clutch-public"
...
def check_readme_first_screen(root: Path, findings: list[dict[str, str]]) -> None:
    ...
    required_positions = (
        ...
        (
            "https://trex-clutch.github.io/clutch-landing-preview/",
            18,
            "online landing preview link must appear before the first screen scroll",
        ),
    )
